    ...
    stages {
        ...
        stage('Accessing AWS internal console') {
             steps {
                ...
                sh "ssh -tt ec2-user@ec2-3-68-216-106.eu-central-1.compute.amazonaws.com 'docker ps && docker kill \$(docker ps -q) && docker rm \$(docker ps -aq) && docker rmi \$(docker images -q)' "
